...
public class PorkOfferVO {
	...
	public String getPorkOfferDetail() {
		return porkOfferDetail;
	}
	public void setPorkOfferDetail(String porkOfferDetail) {
		this.porkOfferDetail = porkOfferDetail;
	}
